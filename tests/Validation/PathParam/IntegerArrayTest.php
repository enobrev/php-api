<?php /** @noinspection PhpUnhandledExceptionInspection */
    ...
    class IntegerArrayTest extends TestCase {
        ...
        public function testIntegersOk(): void {
            $oResponse = $this->getResponse('/testing/path_params/123,456');
            ...
            $this->assertEquals("123,456", $aResponse['_request']['params']['path']['test']);
        ...
        public function testOneIntegerOneString(): void {
            ...
            try {
                $this->getResponse('/testing/path_params/123,abc');
        ...
        public function testTwoStrings(): void {
            ...
            try {
                $this->getResponse('/testing/path_params/abc,def');
            } catch (ValidationException $e) {
                $aContext = $e->getContext();
        ...
        public function testMinItems(): void {
            ...
            try {
                $this->getResponse('/testing/path_params/123');
            } catch (ValidationException $e) {
                $aContext = $e->getContext();
        ...
        public function testMaxItems(): void {
            ...
            try {
                $this->getResponse('/testing/path_params/123,234,345,456,567,678');
            } catch (ValidationException $e) {
                $aContext = $e->getContext();
        ...
        public function testUniqueItems(): void {
            ...
            try {
                $this->getResponse('/testing/path_params/123,123');
            } catch (ValidationException $e) {
                $aContext = $e->getContext();
