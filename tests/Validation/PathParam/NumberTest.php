<?php /** @noinspection PhpUnhandledExceptionInspection */
    ...
    class NumberTest extends TestCase {
        ...
        public function testFloat(): void {
            $oResponse = $this->getResponse('/testing/path_params/23.45');
            ...
            $this->assertEquals("23.45", $aResponse['_request']['params']['path']['test']);
        ...
        public function testString(): void {
            ...
            try {
                ...
                $this->assertStringContainsString('number is required', $aContext[0]['message']);
        ...
        public function testMinimum(): void {
            ...
            try {
                $this->getResponse('/testing/path_params/-200.5');
            } catch (ValidationException $e) {
                $aContext = $e->getContext();
    ...
    class NumberTestClass implements SpecInterface, MiddlewareInterface {
        public function spec(): Spec {
            return Spec::create()
                       ->httpMethod      (Method\GET)
                       ->path            ('/testing/path_params/{test}')
                       ->pathParams      ([
                            'test' => Param\_Number::create()->required()->minimum(-100)->maximum(100)
                        ]);
        }
