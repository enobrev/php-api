<?php /** @noinspection PhpUnhandledExceptionInspection */
    ...
    class SimpleJsonSchemaFailTest extends TestCase {
        /** @var array  */
        private $aPipeline = [];
        ...
        public function setUp(): void {
            ...
            FullSpec::init('', '', ['testing']);
            $oFullSpec = FullSpec::getInstance();
            $oFullSpec->addSpecFromInstance(new SimpleJsonSchemaFailTestClass());
        ...
        public function testFail(): void {
            ...
            try {
                ...
                $this->assertEquals('TEST_OK', $aContext[0]['property']);
    ...
    class SimpleJsonSchemaFailTestClass implements SpecInterface, MiddlewareInterface {
